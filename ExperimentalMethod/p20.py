...
class P20:
    ...
    '''
    The P20 object is the main object for training the RL agent for both of the Experimental Method trials
    ...
    theta : np.ndarray
        ...
        In the Experimental Method it has shape (1, number_of_features * number_of_actions_in_env)
    metrics : Metrics
    ...
    def train(self, start_episode, max_episodes, solved_at, lr, gamma, epsilon, min_epsilon, render, seed):
        ...
        tuple[Metrics, np.ndarray]
            ...
            theta - Learned vector of weights for the RL agent. In the Experimental Method it has shape (1, number_of_features * number_of_actions_in_env)
        '''
